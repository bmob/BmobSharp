...
namespace cn.bmob.io
{
    ...
    public class BmobRemote : BmobObject
    {
        ...
        public BmobRemote FileDelete(String group, String url)
        {
            BmobWrapper.FileDelete(group, url, NonCallback);
            return this;
        }
        ...
        public BmobRemote PhoneVerify(String phone)
        {
            BmobWrapper.PhoneVerify(phone, NonCallback);
            return this;
        }
        ...
        public BmobRemote Reset(String phone, String smsCode, String newPassword)
        {
            BmobWrapper.Reset(phone, smsCode, newPassword, NonCallback);
            return this;
        }
        ...
        public BmobRemote Timestamp()
        {
            BmobWrapper.Timestamp(NonCallback);
            return this;
        }
